...
Look at the pre-lab assignment [lab handout](/img/v4lab.pdf). Try to answer the questions on your own, then look at the following video to see the solutions.
...
There are 15 possible compounds each of your unknowns could be (shown in the lab manual Figure . Go through the same steps as above to identify your unknowns. Remember that you can print the [lab handout](/img/v4lab.pdf) or type your answers in the [Word version](/img/4vlab-worksheet.docx).
