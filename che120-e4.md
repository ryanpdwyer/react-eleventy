...
Here is the [lab handout](/img/v4lab.pdf). **Print it out so that you can complete the results worksheet.** If you prefer, type things using the [Word versions of the results worksheet](/img/v4lab-worksheet.docx). 
...
There are 15 possible compounds each of your unknowns could be (shown in the lab handout Figure 4.4). Go through the same steps as above to identify your unknowns. Remember that you can print the [lab handout](/img/v4lab.pdf) or type your answers in the [Word version](/img/v4lab-worksheet.docx).
...
**The lab is due Week 8. Submit your report to the D2L Dropbox.** Your report will need to include 
