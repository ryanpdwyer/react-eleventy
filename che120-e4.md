...
## Practice using IR and NMR to identify an unknown
...
## Determining the identity of an unknown sample using the spectra
...
<label for="nameInput">Name:</label><input id="nameInput"></input>
<button id="submitName" onclick="chooseUnknowns();">Submit</button>
...
There are 15 possible compounds each of your unknowns could be (shown in the lab handout Figure 4.4). Go through the same steps as above to identify your unknowns.
...
The lab is due to the D2L dropbox folder next week. Your report will need to include

- The IR and NMR spectra of your unknowns. Here are empty versions of the tables you filled out in lab. It is
